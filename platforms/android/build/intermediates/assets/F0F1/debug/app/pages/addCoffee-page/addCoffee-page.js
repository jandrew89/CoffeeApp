...
function coffeeCamera(args) {
    page = args.object;
    cameraModule.takePicture({ width: 200, height: 200, keepAspectRatio: true }).then(function (picture) {
        imageContainer.imageSource = picture;
        //vm.takePhoto(imageContainer);
    });
}
exports.coffeeCamera = coffeeCamera;
// export function clickedDarkCoffeeType(args: GestureEventData) {
//     var coffee = <AddCoffeeViewModel>args.view.bindingContext; 
//     coffee.toggleCoffeeClicked(darkCoffee);
// }
// export function clickedMediumCoffeeType(args: GestureEventData) {
//     var coffee = <AddCoffeeViewModel>args.view.bindingContext;
//     coffee.toggleCoffeeClicked(mediumCoffee);
// }
// export function clickedLightCoffeeType(args: GestureEventData) {
//     var coffee = <AddCoffeeViewModel>args.view.bindingContext;
//     coffee.toggleCoffeeClicked(lightCoffee);
// }
